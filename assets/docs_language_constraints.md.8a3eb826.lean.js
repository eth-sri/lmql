import{_ as t,o as n,c as o,Q as a,k as s,a as e}from"./chunks/framework.c2adf1ba.js";const A=JSON.parse('{"title":"Constraints","description":"","frontmatter":{"outline":[2,3]},"headers":[],"relativePath":"docs/language/constraints.md","filePath":"docs/language/constraints.md"}'),i={name:"docs/language/constraints.md"},r=a("",9),l=s("div",{class:"language-promptdown vp-adaptive-theme"},[s("button",{title:"Copy Code",class:"copy"}),s("span",{class:"lang"},"promptdown"),s("pre",{"pd-text":`A list of things not to forget when going to the sea (not travelling): 
- [THING|Sunscreen]
- [THING|Beach towels]
- [THING|Swimsuit]
- [THING|Sunglasses]
...
`)])])],-1),p=a("",4),d=s("div",{class:"language-promptdown vp-adaptive-theme"},[s("button",{title:"Copy Code",class:"copy"}),s("span",{class:"lang"},"promptdown"),s("pre",{"pd-text":`A number: [N|2]
...
`)])])],-1),c=a("",5),h=s("div",{class:"language-promptdown vp-adaptive-theme"},[s("button",{title:"Copy Code",class:"copy"}),s("span",{class:"lang"},"promptdown"),s("pre",{"pd-text":`A list of things not to forget when going to the sea (not travelling):
- [THING|Sunglasses]
- [THING|Sunscreen]
- [THING|Volleyball]
- [THING|Sunscreen]
...
`)])])],-1),u=a("",3),m=s("div",{class:"language-promptdown vp-adaptive-theme"},[s("button",{title:"Copy Code",class:"copy"}),s("span",{class:"lang"},"promptdown"),s("pre",{"pd-text":`Hello [NAME| ⏎
⏎
I am in]
...
⏎
I am in`)]),e(`
`)])])],-1),g=a("",3),w=s("div",{class:"language-promptdown vp-adaptive-theme"},[s("button",{title:"Copy Code",class:"copy"}),s("span",{class:"lang"},"promptdown"),s("pre",{"pd-text":`Greet the user in four different ways: [GREETINGS|⏎
⏎
...
`)])])],-1),_=a("",6),v=s("div",{class:"language-promptdown vp-adaptive-theme"},[s("button",{title:"Copy Code",class:"copy"}),s("span",{class:"lang"},"promptdown"),s("pre",{"pd-text":`It's the last day of June so today is [DATE|30/06]
...
`)])])],-1),b=a("",5),f=s("div",{class:"language-promptdown vp-adaptive-theme"},[s("button",{title:"Copy Code",class:"copy"}),s("span",{class:"lang"},"promptdown"),s("pre",{"pd-text":`A story about life:
...
`)])])],-1),T=a("",6),y=[r,l,p,d,c,h,u,m,g,w,_,v,b,f,T];function x(q,k,S,C,j,I){return n(),o("div",null,y)}const G=t(i,[["render",x]]);export{A as __pageData,G as default};
