import{_ as n,o as a,c as i,Q as t,k as e,a as s}from"./chunks/framework.c2adf1ba.js";const v=JSON.parse('{"title":"Inference Certificates","description":"","frontmatter":{},"headers":[],"relativePath":"docs/latest/lib/inference-certificates.md","filePath":"docs/latest/lib/inference-certificates.md"}'),l={name:"docs/latest/lib/inference-certificates.md"},c=t("",9),r=e("div",{class:"info custom-block"},[e("p",{class:"custom-block-title"},"Certificate File"),e("div",{class:"language-truncated vp-adaptive-theme"},[e("button",{title:"Copy Code",class:"copy"}),e("span",{class:"lang"},"truncated"),e("pre",{class:"hljs"},[e("code",null,[e("span",{class:"line"},[s(`{
...
`)])])])]),e("button",{class:"btn expand",onclick:"this.parentElement.classList.toggle('show')"}," Show All ")],-1),o=t("",12),p=[c,r,o];function d(h,u,f,m,g,j){return a(),i("div",null,p)}const _=n(l,[["render",d]]);export{v as __pageData,_ as default};
