import{_ as n,o as e,c as t,Q as o,k as s,a}from"./chunks/framework.980cae92.js";const j=JSON.parse('{"title":"⛓️ Constrained LLMs","description":"","frontmatter":{"title":"⛓️ Constrained LLMs"},"headers":[],"relativePath":"features/examples/2-constraining.md","filePath":"features/examples/2-constraining.md"}'),p={name:"features/examples/2-constraining.md"},l=o(`<p>LMQL&#39;s support for constrained generation enables robust interfacing, to integrate LLMs safely into your applications.<a href="../../docs/language/constraints.html">Learn More →</a></p><p>%SPLIT%</p><div class="language-lmql vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">lmql</span><pre class="hljs"><code><span class="line"><span class="hljs-comment"># top-level strings are prompts</span>
