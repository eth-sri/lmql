...
if __name__ == "__main__":
    ...
    parser.add_argument("model", type=str, help = "the huggingface model to use if not llama.cpp else the huggingface tokenizer to proxy the llama.cpp one.")
    parser.add_argument("--llama.cpp", action='store_true', dest="llama_cpp", help="flag determining whether to use llama.cpp server or not.")
