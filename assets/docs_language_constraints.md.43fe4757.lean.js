import{_ as t,o as n,c as o,Q as a,k as s,a as e}from"./chunks/framework.980cae92.js";const A=JSON.parse('{"title":"Constraints","description":"","frontmatter":{"outline":[2,3]},"headers":[],"relativePath":"docs/language/constraints.md","filePath":"docs/language/constraints.md"}'),i={name:"docs/language/constraints.md"},r=a("",9),l=s("div",{class:"language-promptdown vp-adaptive-theme"},[s("button",{title:"Copy Code",class:"copy"}),s("span",{class:"lang"},"promptdown"),s("pre",{"pd-text":`A list of things not to forget when going to the sea (not travelling): 
- [THING|Sunscreen]
- [THING|Beach towels]
- [THING|Swimsuit]
- [THING|Sunglasses]
