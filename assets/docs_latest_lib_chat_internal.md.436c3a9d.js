import{_ as s,o as a,c as n,Q as e}from"./chunks/framework.c2adf1ba.js";const m=JSON.parse('{"title":"Internal Reasoning","description":"","frontmatter":{"order":3},"headers":[],"relativePath":"docs/latest/lib/chat/internal.md","filePath":"docs/latest/lib/chat/internal.md"}'),t={name:"docs/latest/lib/chat/internal.md"},o=e(`<h1 id="internal-reasoning" tabindex="-1">Internal Reasoning <a class="header-anchor" href="#internal-reasoning" aria-label="Permalink to &quot;Internal Reasoning&quot;">​</a></h1><p>While user-facing question-answering is the main goal of LLM-based chatbots, performance can be considerably improved by implementing internal reasoning and reflection mechanisms. In this chapter, we will discuss the implementation of such mechanisms in LMQL Chat.</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="hljs"><code><span class="line">:name: lmql-chat
